...
{
    public partial class GieoQue : System.Web.UI.Page
    {
                ...
                //{
                    ...
                    if (Session["msisdn"] != null)
                    {
                        ...
                        if (!string.IsNullOrEmpty(code))
                        {
                            ...
                            string strResult = AppEnv.DangKyDinhVuTet(Session["msisdn"].ToString(), "TUVI gửi 1119", "TUVI");
                            if (strResult == "0")
                            {
                                pnlThanhCong.Visible = true;
                                litThanhCong.Text = "Đăng ký thành công. Hàng ngày hệ thống sẽ gửi thông tin tư vấn về máy điện thoại của bạn !";
                            }
                            else if (strResult == "1")
                            {
                                pnlThanhCong.Visible = true;

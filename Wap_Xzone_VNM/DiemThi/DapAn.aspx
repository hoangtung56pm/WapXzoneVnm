<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DapAn.aspx.cs" Inherits="WapXzone_VNM.Diemthi.DapAn" %>
...
<body>
    ...
    <asp:Panel ID="pnlYeuCau" runat="server" Visible="true">        
        <div class="boxcontent">
            <div class="listlink">
    	        <span class="bold pink"><asp:Literal ID="ltrMaKhoi" runat="server"></asp:Literal></span>
            </div>
   	        <div class="listlink">
   	            <asp:TextBox ID="txtMaKhoi" CssClass="sfrminput input80" runat="server"></asp:TextBox>
            </div>
            <div class="listlink">
    	        <span class="bold pink"><asp:Literal ID="ltrMaMon" runat="server"></asp:Literal></span>
            </div>
   	        <div class="listlink">
   	            <asp:TextBox ID="txtMaMon" CssClass="sfrminput input80" runat="server"></asp:TextBox>
            </div>
            <div class="listlink">
    	        <span class="bold pink"><asp:Literal ID="ltrMaDe" runat="server"></asp:Literal></span>
            </div>
   	        <div class="listlink">
   	            <table cellpadding="0" cellspacing="0">
   	                <tr>
   	                    <td><asp:TextBox ID="txtMaDe" CssClass="sfrminput input80" runat="server"></asp:TextBox></td>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DiemChuan.aspx.cs" Inherits="WapXzone_VNM.Diemthi.DiemChuan" %>
    ...
    <asp:Panel ID="pnlYeuCau" runat="server" Visible="true">        
        <div class="boxcontent">
	        <div class="listlink">
   	        ...
   	        <div class="listlink">
   	            <asp:TextBox ID="txtMaTruong" CssClass="sfrminput input80" runat="server"></asp:TextBox>
            </div>
            <div class="listlink">
    	        <span class="bold pink"><asp:Literal ID="ltrMaNganh" runat="server"></asp:Literal></span>
            </div>
   	        <div class="listlink">
   	            <table cellpadding="0" cellspacing="0">
   	                <tr>
   	                    <td><asp:TextBox ID="txtMaNganh" CssClass="sfrminput input80" runat="server"></asp:TextBox></td>

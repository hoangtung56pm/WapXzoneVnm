<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XH_PTTH.aspx.cs" Inherits="WapXzone_VNM.Diemthi.XH_PTTH" %>
...
<body>
    ...
    <asp:Panel ID="pnlYeuCau" runat="server" Visible="true">        
        <div class="boxcontent">
	        <div class="listlink">
    	        <span class="bold pink"><asp:Literal ID="ltrMaTinh" runat="server"></asp:Literal></span>
            </div>
   	        <div class="listlink">
   	            <asp:TextBox ID="txtMaTinh" CssClass="sfrminput input80" runat="server"></asp:TextBox>
            </div>
            <div class="listlink">
    	        <span class="bold pink"><asp:Literal ID="ltrSoBaoDanh" runat="server"></asp:Literal></span>
            </div>
   	        <div class="listlink">
   	            <table cellpadding="0" cellspacing="0">
   	                <tr>
   	                    <td><asp:TextBox ID="txtSoBaoDanh" CssClass="sfrminput input80" runat="server"></asp:TextBox></td>

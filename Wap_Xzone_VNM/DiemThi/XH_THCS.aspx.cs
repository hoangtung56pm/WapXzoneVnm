...
{
    public partial class XH_THCS : BasePage
    {
        private int width;        
        private string lang;                
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (lang == "1")
            {
                ltrDichvu.Text = "XẾP HẠNG THCS 2011";
            }
            else
            {
                ltrDichvu.Text = "XEP HANG THCS 2011";
            }
        ...
        protected void HienThiNoiDung(Boolean cuphapDung, Boolean thanhToan)
        {
            ...
            logger.Debug("Diem thi: XH_THCS - parameter: " + price + " - " + txtMaTinh.Text.Trim() + " " + txtSoBaoDanh.Text.Trim());            
        ...
        protected void btnThucHien_Click(object sender, ImageClickEventArgs e)
        {
            if (telCo == "Undefined")
            {
                ...
                if (lang == "1")
                {
                    ltrSMS.Text = "Soạn tin <b>VTXH " + (txtMaTinh.Text.Trim().Length > 0 ? txtMaTinh.Text.Trim() : "&lt;Mã tỉnh&gt;") + " " + (txtSoBaoDanh.Text.Trim().Length > 0 ? txtSoBaoDanh.Text.Trim() : "&lt;Số báo danh&gt;") + "</b> gửi <b>" + ConfigurationSettings.AppSettings.Get("diemthicommandcode") + "</b> để tra điểm tốt nghiệp THCS" + Resources.Resource.wChon3G;
                }
                else
                {
                    ltrSMS.Text = "Soan tin <b>VTXH &lt;" + (txtMaTinh.Text.Trim().Length > 0 ? txtMaTinh.Text.Trim() : "&lt;Ma tinh&gt;") + " " + (txtSoBaoDanh.Text.Trim().Length > 0 ? txtSoBaoDanh.Text.Trim() : "&lt;So bao danh&gt;") + "</b> gui <b>" + ConfigurationSettings.AppSettings.Get("diemthicommandcode") + "</b> de tra diem tot nghiep THCS" + Resources.Resource.wChon3G_KD;
                }
            }
            else
            {
                ...
                objResulnInfo = objMbox.QueryOrderDCS_Standard(Session["msisdn"].ToString(), txtMaTinh.Text.Trim().ToUpper(), txtSoBaoDanh.Text.Trim(), "1", "VTXH", "8579", "1");
                
                chitietGiaodich = "XH THCS: ";

...
namespace WapXzone_VNM.Game
{
    public partial class Download : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string ms = "";
            if (Session["msisdn"] != null) ms = Session["msisdn"].ToString();
            if (gc.Login(ms, 4))
            {
        ...
        protected void HienThiNoiDung(Boolean thuchien,Boolean isLog,string price)
        {
            ...
            if (freecate == false)
            {
                ...
                logger.Debug("--------------------------------------------------");
                logger.Debug("MSISDN:" + AppEnv.CheckFreeContentMsisdn());

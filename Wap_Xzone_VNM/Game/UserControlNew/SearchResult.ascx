<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SearchResult.ascx.cs"
    Inherits="WapXzone_VNM.Game.UserControlNew.SearchResult" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td width="125%" align="left" valign="middle" background="/imagesnew/bgrtop2.gif"
                        class="style1">
                        <asp:Literal ID="ltrTenChuyenMuc" runat="server" EnableViewState="False"></asp:Literal>
                    </td>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" background="/imagesnew/bgrgame.gif">
                        <tr>
                            ...
                            <td width="125%" align="left" valign="top" class="style2">
                                ...
                                <strong>
                                    <asp:HyperLink CssClass="link-non-black" ID="lnkTai" runat="server" EnableViewState="False">Tải</asp:HyperLink>
                                </strong>
                            </td>
                            <td align="left" valign="top">

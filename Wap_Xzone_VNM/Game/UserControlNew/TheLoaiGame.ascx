<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TheLoaiGame.ascx.cs"Inherits="WapXzone_VNM.Game.UserControlNew.TheLoaiGame" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td align="left" valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td width="125%" align="left" valign="middle" background="/imagesnew/bgrtop2.gif"
                        class="style1">
                        <%= AppEnv.CheckLang("Thể loại game")%>
                    </td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <asp:Repeater ID="rptTheLoaiGame" runat="server" EnableViewState="false">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td width="11" align="left" valign="middle" bgcolor="dedbd6">
                                <img alt="" src="/imagesnew/iconvideo.jpg" width="15" height="15" />
                            </td>
                            <td width="8" align="left" valign="middle" bgcolor="dedbd6">
                                <img alt="" src="/imagesnew/blank.gif" width="8" height="25" />
                            </td>
                            <td align="left" valign="middle" bgcolor="dedbd6" class="style10">
                                <asp:HyperLink runat="server" ID="lnkCatLink">
                                    <%# AppEnv.CheckLang(Eval("Title_Unicode").ToString())%>
                                </asp:HyperLink>
                            </td>
                        </tr>
                    </ItemTemplate>

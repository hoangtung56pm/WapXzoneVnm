<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DownloadNew.aspx.cs" Inherits="WapXzone_VNM.Hinhnen.DownloadNew" %>
...
<%@ Register Src="UserControlNew/TheLoaiHinhNen.ascx" TagName="TheLoaiHinhNen" TagPrefix="uc4" %>
...
<head>
    <title>.: Vietnamobile - Download Hinh nen :.</title>
...
<body>
    ...
    <uc4:TheLoaiHinhNen ID="TheLoaiHinhNen1" runat="server" EnableViewState="False" />

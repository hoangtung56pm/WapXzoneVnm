<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="List.ascx.cs" Inherits="WapXzone_VNM.Hinhnen.UserControlNew.List" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td width="125%" align="left" valign="middle" background="/imagesnew/bgrtop2.gif"
                        class="style1">
                        <asp:HyperLink ID="lnkHomeChannel" CssClass="link-non-white" runat="server">ANH</asp:HyperLink>
                        »
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" background="/imagesnew/bgrclip.gif">
                        <tr>
                            ...
                            <td width="125%" align="left" valign="top" class="style2">
                                ...
                                <br />
                                <span class="style10">
                                    <asp:Literal ID="ltrTheloai" runat="server"></asp:Literal><br />
                                    <asp:Literal ID="ltrLuottai" runat="server"></asp:Literal><br />
                                    <asp:HyperLink CssClass="link-non-black text-bold" ID="lnkTai" runat="server"><span class="orange bold">Tải</span></asp:HyperLink>
                                </span>
                                <br />
                                <br />
                            </td>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DownloadHigh.aspx.cs" Inherits="WapXzone_VNM.Music.DownloadHigh" %>
...
<%@ Register src="/Music/UserControlHigh/MoiNhat.ascx" tagname="MoiNhat" tagprefix="uc5" %>
<%@ Register src="/Music/UserControlHigh/BaiHatTheoCaSy.ascx" tagname="BaiHatTheoCaSy" tagprefix="uc6" %>
<%@ Register src="/Music/UserControlHigh/BaiHatTheoTheLoai.ascx" tagname="BaiHatTheoTheLoai" tagprefix="uc7" %>
...
<head runat="server">
    ...
    <title>.: Vietnamobile - Am nhac :.</title>
...
<body>
    ...
    <uc5:MoiNhat ID="MoiNhat1" runat="server" EnableViewState="False" />   
            
    <%--Bai Hat Theo Ca Sy--%>
    <uc6:BaiHatTheoCaSy ID="BaiHatTheoCaSy1" runat="server" EnableViewState="False" />   

    <%--Bai Hat Theo The Loai--%>
    <uc7:BaiHatTheoTheLoai ID="BaiHatTheoTheLoai1" runat="server" EnableViewState="False" />  

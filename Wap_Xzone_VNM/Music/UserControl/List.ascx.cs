...
namespace WapXzone_VNM.Music.UserControl
{
    public partial class List : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            free = ConvertUtility.ToInt32(Request.QueryString["f"]).ToString();
            ...
            //start category list
            int totalrecord = 0;
            DataTable dtCat = MusicController.GetItemWithPagingHasCache(Session["telco"].ToString(), curpage, pagesize, out totalrecord);
        ...
        protected void rptlstCategory_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            lnkTai.NavigateUrl = "../Download.aspx?id=" + curData["W_MItemID"].ToString() + "&lang=" + lang + "&w=" + width + "&f=" + free;

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NewsHot.ascx.cs" Inherits="WapXzone_VNM.Music.UserControlNew.NewsHot" %>
    ...
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="125%" align="left" valign="middle" background="/imagesnew/bgrtop2.gif" class="style1">
            Tin showbiz <span class="style5"> &gt;&gt;<a class="link-non-white" href="<%= UrlProcess.GetNewsHomeUrlNew(lang.ToString(),width) %>"><%= AppEnv.CheckLang("Xem thêm") %></a></span>
        </td>

        <td align="left" valign="top" background="/imagesnew/bgrtop2.gif"><img alt="" src="/imagesnew/righttit.jpg" width="65" height="25" /></td>
      </tr>
      <tr>
        <td colspan="3" align="left" valign="top" bgcolor="#EDEDED"><img alt="" src="/imagesnew/blank.gif" width="5" height="9" /></td>
      </tr>
    </table>
        ...
        <ItemTemplate>
          ...
          <tr>
            ...
            <table width="82" border="0" align="left" cellpadding="0" cellspacing="0">
                ...
                <span class="style2"><%# AppEnv.CheckLang(Eval("Content_Teaser").ToString())%> </span><span class="style4"><br />
              </span></td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="top" bgcolor="#FFFFFF"><img alt="" src="/imagesnew/blank.gif" width="5" height="9" /></td>
          </tr>
      </table>

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StyleDetail.ascx.cs" Inherits="WapXzone_VNM.Music.UserControlNew.StyleDetail" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td width="125%" align="left" valign="middle" background="/imagesnew/bgrtop2.gif"
                        class="style1">
                        <asp:Literal ID="ltrStyleName" runat="server" EnableViewState="False"></asp:Literal>
                    ...
                    <tr>
                        ...
                        <td colspan="3" align="left" valign="middle">
                            ...
                            <span
                                ...
                                <asp:Literal ID="ltrCaSy" runat="server" EnableViewState="False"></asp:Literal><br />
                                <asp:HyperLink ID="lnkTai" CssClass="link-non-black" runat="server" EnableViewState="False"></asp:HyperLink>
                            </span>
                        </td>
                    </tr>
                    <tr>

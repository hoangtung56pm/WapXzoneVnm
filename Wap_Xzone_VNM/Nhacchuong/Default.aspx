<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WapXzone_VNM.Nhacchuong.Default" %>
...
<head>
    <title>.: Wap Vietnamobile - Nhac chuong :.</title>
...
<body>
    ...
    <div class="boxcontent">
	    <p> <img src="../img/hot_icon.gif"> <asp:Literal ID="ltrKhuyenmai" runat="server" EnableViewState="False">Khuyến mãi cực kỳ hấp dẫn: Mua 1 tặng 1.</asp:Literal> </p>
    </div>
    <div class="clearfix"></div>
    <%--Content here--%>    

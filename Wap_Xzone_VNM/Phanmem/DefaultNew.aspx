<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefaultNew.aspx.cs" Inherits="WapXzone_VNM.Phanmem.DefaultNew" %>
...
<body>
    ...
    <%--End Content--%>
    <uc4:Category ID="Category1" runat="server" EnableViewState="False" />

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Detail.ascx.cs" Inherits="WapXzone_VNM.Phanmem.UserControlNew.Detail" %>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                            ...
                            <tr>
                                <td align="left" valign="top" bgcolor="c6c6c6">
                                    <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                        <tr>
                                            <td bgcolor="#EDEDED">
                                                <asp:Image ID="imgDetail" runat="server" EnableViewState="False" alt="thumb" Width="120"
                                                    Height="141" />
                                            </td>
                                        </tr>
                                    </table>
                    ...
                    <td width="125%" align="left" valign="top" class="style2">
                        <span class="style4">
                            <asp:Literal ID="ltrTenAnh" runat="server" EnableViewState="False"></asp:Literal>
                        </span>
                        <br />
                        <asp:Literal ID="ltrNhom" runat="server" EnableViewState="False"></asp:Literal><br />
                        <asp:Literal ID="ltrGiaTai" runat="server" EnableViewState="False"></asp:Literal><br />
                        <asp:Literal ID="ltrGioiThieu" runat="server" EnableViewState="False"></asp:Literal>
                    </td>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="125%" align="left" valign="middle">
                                    <strong>
                                        <asp:HyperLink CssClass="link-non-black" ID="lnkTai" runat="server" EnableViewState="False"><span class="bold">Tải về</span></asp:HyperLink>
                                    </strong>
                                </td>
                            </tr>
                        </table>
        ...
        <td align="left" valign="top">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td width="125%" align="left" valign="middle" background="/imagesnew/bgrtop2.gif"
                        class="style1">
                        <asp:Literal ID="ltrCungTheLoai" runat="server" EnableViewState="False">CÙNG THỂ LOẠI</asp:Literal>
                    </td>
                    <td align="left" valign="top" background="/imagesnew/bgrtop2.gif">
                        <img alt="" src="/imagesnew/righttit.jpg" width="65" height="25" />
                    </td>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" background="/imagesnew/bgrgame.gif">
                        <tr>
                            ...
                            <td width="125%" align="left" valign="top" class="style2">
                                ...
                                <strong>
                                    <asp:HyperLink CssClass="link-non-black" ID="lnkTai" runat="server" EnableViewState="False"><span class="orange bold">Tải</span></asp:HyperLink>
                                </strong>
                            </td>
                            <td align="left" valign="top">
                                <img alt="" src="/imagesnew/blank.gif" width="8" height="5" />
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td width="125%" align="left" valign="middle">
                        <span class="style11">(<%= AppEnv.CheckLang("Giá") %>:
                            <%= AppEnv.GetSetting("appprice")%>
                            <%= AppEnv.CheckLang("đ/phần mềm")%>)</span>
                    </td>
                </tr>
            </table>
        </td>

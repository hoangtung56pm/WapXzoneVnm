<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Pagging.ascx.cs" Inherits="WapXzone_VNM.Phanmem.UserControlNew.Pagging" %>

<div style="text-align: center;" class="item">
    <asp:Literal ID="ltrNoData" runat="server" EnableViewState="False" Visible="false">Khong co phan mem ho tro may cua ban.</asp:Literal>

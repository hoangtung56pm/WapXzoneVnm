<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dangky.aspx.cs" Inherits="WapXzone_VNM.Sub.dangky" %>
...
<head>
    <title>.: Wap Vietnamobile - Dich Vu Sub :.</title>
...
<body>
    ...
    <asp:Panel ID="pnlNoiDung" runat="server" Visible="false">
        <div class="rbroundbox">
            <div class="rbtop">
                <div>
                    <asp:Literal ID="ltrTieuDe" runat="server">Dịch vụ Sub</asp:Literal></div>
            </div>
        </div>

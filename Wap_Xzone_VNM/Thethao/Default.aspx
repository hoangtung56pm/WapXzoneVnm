<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WapXzone_VNM.Thethao.Default" %>
...
<%@ Register src="UserControl/QuickMenu.ascx" tagname="QuickMenu" tagprefix="uc2" %>
<%--<%@ Register src="UserControl/Category.ascx" tagname="Category" tagprefix="uc2" %>--%>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>.: Wap Vietnamobile - The thao :.</title>
...
<body>
    ...
    <%--end Content here--%>
    <uc2:QuickMenu ID="QuickMenu1" runat="server" EnableViewState="False" />

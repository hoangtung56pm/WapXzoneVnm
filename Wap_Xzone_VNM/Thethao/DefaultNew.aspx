<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefaultNew.aspx.cs" Inherits="WapXzone_VNM.Thethao.DefaultNew" %>
...
<body>
    ...
    <%--End Content--%>
    <uc4:QuickMenu ID="QuickMenu1" runat="server" EnableViewState="False" />

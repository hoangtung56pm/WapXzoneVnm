...
{
    public partial class ThongKeNew : BasePage
    {
        private int width;
        private string lang;
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        //    ltrThongBao.Text = Resources.Resource.wXacNhanDichVu + "dịch vụ thống kê trận " + ykcg.Rows[0]["Team_Name1"].ToString() + " - " + ykcg.Rows[0]["Team_Name2"].ToString();                               
                        ...
                        //    ltrThongBao.Text = Resources.Resource.wXacNhanDichVu_KD + "dich vu thong ke tran " + ykcg.Rows[0]["Team_Name1"].ToString() + " - " + ykcg.Rows[0]["Team_Name2"].ToString();
                        ...
                        switch (Session["telco"].ToString())
                        {
                            case "Vietnamobile":
                                ...
                                //messageReturn = charging.PaymentVNM(Session["msisdn"].ToString(), price, "D", "YKCG", Request.QueryString["id"].ToString());
        ...
        protected void HienThiNoiDung(Boolean thuchien, Boolean log)
        {
            ...
            if (thuchien)
            {
                ...
                if (log) Transaction.Success(Session["telco"].ToString(), Session["msisdn"].ToString(), price, Request.Url.ToString(), gameid, chitietGiaodich, 6);
            }
            else
            {
                ...
                if (log) Transaction.Failure(Session["telco"].ToString(), Session["msisdn"].ToString(), price, Request.Url.ToString(), gameid, chitietGiaodich, 6, messageReturn);
                //--Thông báo lỗi thanh toán                
            }
            if (log)
            {

...
namespace WapXzone_VNM.Thethao.UserControlNew
{
    public partial class Gold : System.Web.UI.UserControl
    {
        ...
        protected void rptNewLastest_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            //Literal ltrTeaser = (Literal) e.Item.FindControl("litTeaser");
            ...
            if (e.Item.ItemIndex == 0)
            {
                ...
                else
                {
                    ...
                    litTeaser.Text = curData["Content_TeaserKD"].ToString();   
                }
                //Ảnh đại diện
                ...
                else
                {
                    ...
                    ws.GenerateAvatarThumnail(curData["Content_Avatar"].ToString(), 82, 65);
                    imgAvatar.ImageUrl = preurl + MultimediaUtility.GetAvatarThumnail(curData["Content_Avatar"].ToString(), 82, 65).Replace("~", "");
                }
                lnkTitle.NavigateUrl = UrlProcess.GetSportNewsDetailUrlNew(lang.ToString(), width, ConvertUtility.ToInt32(curData["Distribution_ID"].ToString()));
            ...
            else
            {
                ...
                lnkTitlelist.NavigateUrl = UrlProcess.GetSportNewsDetailUrlNew(lang.ToString(), width, ConvertUtility.ToInt32(curData["Distribution_ID"].ToString()));
                pn.Visible = true;
            }

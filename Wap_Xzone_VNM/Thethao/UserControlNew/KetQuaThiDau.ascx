<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="KetQuaThiDau.ascx.cs" Inherits="WapXzone_VNM.Thethao.UserControlNew.KetQuaThiDau" %>
    ...
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="125%" align="left" valign="middle" background="/imagesnew/bgrtop2.gif" class="style1">
            <asp:HyperLink CssClass="link-non-white" ID="lnkTheThao" runat="server" EnableViewState="False"></asp:HyperLink> » <asp:Literal ID="ltrLichthidau" runat="server" EnableViewState="False"></asp:Literal>
        </td>

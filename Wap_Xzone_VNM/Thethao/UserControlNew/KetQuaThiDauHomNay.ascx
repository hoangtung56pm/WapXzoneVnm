<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="KetQuaThiDauHomNay.ascx.cs" Inherits="WapXzone_VNM.Thethao.UserControlNew.KetQuaThiDauHomNay" %>
    ...
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="125%" align="left" valign="middle" background="/imagesnew/bgrtop2.gif" class="style1">
            <asp:HyperLink ID="lnkTheThao" runat="server" CssClass="link-non-white" EnableViewState="False"></asp:HyperLink> 
                » 
            <asp:Literal ID="ltrKetQuaThiDauHomNay" runat="server" EnableViewState="False"></asp:Literal>
        </td>
        ...
        <ItemTemplate>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="8" align="left" valign="middle" bgcolor="dedbd6"><img alt="" src="/imagesnew/blank.gif" width="8" height="25" /></td>
                          <td align="left" valign="middle" bgcolor="dedbd6" class="style15"> <asp:Literal ID="ltrGiaiDau" runat="server" EnableViewState="False"></asp:Literal></td>
                        </tr>
                    </table>
                ...
                <ItemTemplate>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td align="center" valign="top" class="style14"><%# Eval("Team1Score")%> - <%# Eval("Team2Score")%> </td>
                        ...
                        <tr>
                          <td colspan="3" align="center" valign="top">
                            <span class="style10">
                                <%# ConvertUtility.ToDateTime(Eval("StartTime")).ToString("dd/MM/yyyy HH:mm")%>
                            </span>
                         </td>
                        </tr>
                        <tr>

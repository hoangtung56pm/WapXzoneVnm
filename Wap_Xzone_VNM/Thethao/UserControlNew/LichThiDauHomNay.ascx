<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LichThiDauHomNay.ascx.cs" Inherits="WapXzone_VNM.Thethao.UserControlNew.LichThiDauHomNay" %>
      ...
      <tr>
        ...
        <td width="125%" align="left" valign="middle" background="/imagesnew/bgrtop2.gif" class="style1">
            <asp:HyperLink ID="lnkTheThao" runat="server" CssClass="link-non-white" EnableViewState="False"></asp:HyperLink> 
                » 
            <asp:Literal ID="ltrLichThiDauHomNay" runat="server" EnableViewState="False"></asp:Literal>
        </td>

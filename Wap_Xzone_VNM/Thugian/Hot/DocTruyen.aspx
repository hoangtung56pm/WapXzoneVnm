<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocTruyen.aspx.cs" Inherits="WapXzone_VNM.Thugian.Hot.DocTruyen" %>
...
<head>
    <title>.: Vietnamobile - Doc Truyen :.</title>
...
<body>
    ...
    <asp:Panel ID="pnlThongBao" Visible="false" runat="server" EnableViewState="false">
     ...
     <div class="boxcontent">
        <p>
            <b>
                 Quý khách sẽ được đọc miễn phí những truyện hay dưới đây và được chọn ngẫu nhiên để trúng thưởng Samsung Galaxy S4 hàng tháng. 
            </b>
        </p>
    </div>
    ...
    <div class="rbroundbox">
	    <div class="rbtop"><div><span>Chào mừng bạn đến với dịch vụ Đọc Truyện (Miễn Phí) của Vietnamobile</span></div></div>
    </div>

    <div class="boxcontent">
        

        <asp:Repeater ID="rptDocTruyen" runat="server" EnableViewState="false">
            <ItemTemplate>
                <div class="item">

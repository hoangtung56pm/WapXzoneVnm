        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                //{
                    ...
                    if (parentCatID.ToString() == "255" && WapController.W4A_Subscriber_IsActive(msisdn, 1))
                    {
                        HienThiNoiDung(true, false);
                    }
                    else
                    {
                        if (Session["ChargedSub"] != null)
                        {
                            if (!string.IsNullOrEmpty(Session["ChargedSub"].ToString()))
                            {
                                HienThiNoiDung(true, false);
                            }
                        }

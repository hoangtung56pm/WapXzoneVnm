...
namespace WapXzone_VNM.Thugian.Hot
{
    public partial class HoangDao : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("/Thugian/Hot/HoangDao.aspx?w=320&lang=1");
            }
            ...
            if (!IsPostBack)
            {
                ...
                DataTable dt = TintucController.GetTopRandomForHoangDao();
                if (dt != null && dt.Rows.Count > 0)
                {
                    rptHoangDao.DataSource = dt;
                    rptHoangDao.DataBind();
                }
            }
        }

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefaultNew.aspx.cs" Inherits="WapXzone_VNM.Tintuc.DefaultNew" %>
...
<%@ Register Src="UserControlNew/CacChuyenMuc.ascx" TagName="CacChuyenMuc" TagPrefix="uc4" %>
...
<body>
    ...
    <uc4:CacChuyenMuc ID="CacChuyenMuc1" runat="server" EnableViewState="False" />

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="View.aspx.cs" Inherits="WapXzone_VNM.VClip.View" %>
...
<body>
    ...
    <div class="main-container">
        <asp:Panel ID="pnlSMS" runat="server" Visible="false">
            <asp:Literal ID="ltrHuongdan" runat="server"></asp:Literal><div class="clear10px">
            </div>

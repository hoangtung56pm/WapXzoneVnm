<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefaultHigh.aspx.cs" Inherits="WapXzone_VNM.Video.DefaultHigh" %>
...
<div class="body">
    ...
    <asp:PlaceHolder EnableViewState="True" runat="server" ID="plContent"></asp:PlaceHolder>

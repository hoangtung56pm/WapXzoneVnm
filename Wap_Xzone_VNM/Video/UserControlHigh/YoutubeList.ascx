<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="YoutubeList.ascx.cs" Inherits="WapXzone_VNM.Video.UserControlHigh.YoutubeList" %>
...
<div class="category-video">
        ...
        <div class="title-video">
            <span>
                <asp:Label ID="lblCategorryName" Text="PHIM HOT" runat="server" EnableViewState="false"></asp:Label>
            </span>

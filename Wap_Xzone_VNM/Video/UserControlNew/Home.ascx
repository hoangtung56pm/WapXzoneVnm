<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Home.ascx.cs" Inherits="WapXzone_VNM.Video.UserControlNew.Home" %>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" background="/imagesnew/bgrclip.gif">
                        <tr>
                            ...
                            <td width="125%" align="left" valign="top" class="style2">
                                <span class="style4"><a class="link-non-orange" href="<%# UrlProcess.GetVideoDetailUrlNew(lang.ToString(),"detail",width,Eval("W_VItemID").ToString()) %>">

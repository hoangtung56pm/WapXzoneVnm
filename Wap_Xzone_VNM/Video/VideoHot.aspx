<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VideoHot.aspx.cs" Inherits="WapXzone_VNM.Video.VideoHot" %>
...
<head>
    <title>.: Vietnamobile - Video Hot :.</title>
...
<body>
    ...
    <asp:Panel ID="pnlThongBao" Visible="false" runat="server" EnableViewState="false">
        ...
        <p>
            <b>
                 Quý khách sẽ được miễn phí tải trực tiếp clip dưới đây, nhận 7 link tải clip MIỄN PHÍ nữa qua sms. và được chọn ngẫu nhiên để trúng thưởng Samsung Galaxy S4 hàng tháng. 
            </b>
        </p>
    </div>

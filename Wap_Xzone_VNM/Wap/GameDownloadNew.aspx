<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GameDownloadNew.aspx.cs" Inherits="WapXzone_VNM.Wap.GameDownloadNew" %>
...
<head>
    <title>.: Vietnamobile - Game Free Download :.</title>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="125%" align="left" valign="middle" background="/imagesnew/bgrtop2.gif" class="style1">
            <%= AppEnv.CheckLang("Game miễn phí")%>
        </td>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <asp:Repeater ID="rptGameFree" runat="server">

            <ItemTemplate>
                 <tr>
            <td width="8" align="left" valign="middle" bgcolor="dedbd6"><img alt="" src="/imagesnew/blank.gif" width="8" height="25" /></td>
            <td width="11" align="left" valign="middle" bgcolor="dedbd6"><img alt="" src="/imagesnew/game-icon.png" width="16" height="16" /></td>
            <td width="8" align="left" valign="middle" bgcolor="dedbd6"><img alt="" src="/imagesnew/blank.gif" width="8" height="25" /></td>
            <td align="left" valign="middle" bgcolor="dedbd6" class="style10"><strong>

                <asp:HyperLink CssClass="link-non-black" ID="lnkFile" runat="server"></asp:HyperLink> 
            ...
            <td align="left" valign="middle"><img alt="" src="/imagesnew/game-icon.png" width="16" height="16" /></td>

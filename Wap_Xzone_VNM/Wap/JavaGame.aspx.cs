...
{
    public partial class JavaGame : BasePage
    {
        private int width;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //    DataTable dtMusic = GameController.GetAllGameJavaHasCache();
            //    title.Text = "<style type=\"text/css\">body {font-family:Verdana, Arial, Helvetica; font-size:12px;} .mainmenu {display:block;width: 100%;background-color: #EA6A00;color:#fff;text-align:center;line-height:25px;} .mainmenu a{color:#fff;} a:link, a:visited {text-decoration:none;}</style>";
            //    //if (lang == "1")
            //    //{
            //    //    title.Text += "<div style=\"background-color:#EA6A00;color:#FFFFFF;display:block;line-height:25px;width:100%;margin-top:5px;padding-left:5px;font-weight:bold;\">" + "Chào mừng bạn đến với dịch vụ <b style=\"color:blue\">Java Game</b> của Vietnamobile" + "</div>";
            //    //}
            //    //else
            //    //{
            //    //    title.Text += "<div style=\"background-color:#EA6A00;color:#FFFFFF;display:block;line-height:25px;width:100%;margin-top:5px;padding-left:5px;font-weight:bold;\">" + "Chao mung ban den voi dich vu <b style=\"color:blue\">Java Game</b> cua Vietnamobile" + "</div>";
            //    //}
            ...
            //        lnkfile.NavigateUrl = AppEnv.GetSetting("JavaGameDownloadPartner") + "?id=" + row["GameID"] + "&code=" + SecurityMethod.MD5Encrypt(row["GameID"] + "_" + msisdn) + "&msisdn=" + msisdn;

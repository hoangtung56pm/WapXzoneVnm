<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="S2_Result.aspx.cs" Inherits="WapXzone_VNM.Wap.S2.CLIP.S2_Result" %>
...
<head>
    <title>.: Wap Vietnamobile - Video Clip :.</title>
...
<body>
    ...
    <asp:Panel ID="pnlNoiDung" runat="server" Visible="false">
        <div class="rbroundbox">
            <div class="rbtop">
                <div>
                    <asp:Literal ID="ltrTieuDe" runat="server">VIDEO CLIP</asp:Literal></div>
            </div>
        </div>

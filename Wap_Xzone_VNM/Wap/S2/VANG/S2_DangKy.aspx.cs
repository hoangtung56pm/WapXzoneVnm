    ...
    public partial class S2_DangKy : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                {
                    string value = AppEnv.GetRegisterService(Session["msisdn"].ToString(), AppEnv.GetSetting("S2DK_VANG"));
                    if (value == "1")
                    {
                        pnlSMS.Visible = true;
                        if (lang == "1")
                        {
                            ltrHuongdan.Text = "Giá Vàng";
                            ltrSMS.Text =
                                "Bạn đã là thuê bao của dịch vụ Tra cứu giá vàng hàng ngày. Xin cảm ơn <br/> Để hủy dịch vụ vui lòng SOẠN TIN : <b> HUY VA </b> gửi <b>" + AppEnv.GetSetting("S2ShortCode") + "</b>";
                        }
                        else
                        {
                            ltrHuongdan.Text = "Gia Vang";
                            ltrSMS.Text =
                                "Ban da la thue bao cua dich vu Tra cuu gia vang hang ngay. Xin cam on <br/> De huy dich vu vui long SOAN TIN : <b> HUY VA </b> gui <b>" + AppEnv.GetSetting("S2ShortCode") + "</b>";
                        }
                    }
                    else
                    {
                        ...
                        if (AppEnv.GetSetting("94x_Confirm_Flag") == "1")
                        {
                            ...
                            if (lang == "1")
                            {
                                ...
                                ltrThongBaoNoiDung.Text =
                                    "Bạn có đồng ý đăng ký dịch vụ Tra cứu giá vàng hàng ngày của Vietnamobile hay không (miễn phí đăng ký) ?";
                            ...
                            else
                            {
                                ...
                                ltrThongBaoNoiDung.Text =
                                    "Ban co dong y dang ky dich vu Tra cuu gia vang hang ngay cua Vietnamobile hay khong (mien phi dang ky) ?";
                            }
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                string message = AppEnv.GetSetting("S2DK_VANG");
                ...
                else
                {
                    ...
                    if (lang == "1")
                    {
                        ...
                        ltrSMS.Text =
                            "Hệ thống không xác định được số điện thoại của bạn. Vui lòng truy cập bằng 3G/GPRS hoặc soạn tin: DK VA gửi " + AppEnv.GetSetting("S2ShortCode");
                    }
                    else
                    {
                        ltrHuongdan.Text = "Gioi Thieu";
                        ltrSMS.Text =
                            "He thong khong xac dinh duoc so dien thoai cua ban. Vui long truy cap bang 3G/GPRS hoac soan tin DK VA gui" + AppEnv.GetSetting("S2ShortCode");
                    }
                }

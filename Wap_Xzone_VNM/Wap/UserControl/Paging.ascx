<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Paging.ascx.cs" Inherits="WapXzone_VNM.Wap.UserControl.Paging" %>
<div style="text-align: center;" class="item">
    <asp:Literal ID="ltrNoData" runat="server" EnableViewState="False" Visible="false">Khong co noi dung ho tro may cua ban.</asp:Literal>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WallpaperDownloadNew.aspx.cs"Inherits="WapXzone_VNM.Wap.WallpaperDownloadNew" %>
...
<head>
    <title>.: Vietnamobile - Hinh Nen Free Download :.</title>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td align="left" valign="top">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="125%" align="left" valign="middle" background="/imagesnew/bgrtop2.gif"
                            class="style1">
                            <%= AppEnv.CheckLang("Hình nền miễn phí")%>
                        </td>
                ...
                <asp:Repeater ID="rptHinhNen" runat="server" EnableViewState="false">
                    <ItemTemplate>
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" background="/imagesnew/bgrclip.gif">
                            <tr>
                                ...
                                <img alt="" src="<%# AppEnv.GetSetting("urldata") + Eval("Path").ToString().Replace("~/", "") %>" width="82" height="66" hspace="3" vspace="3" />
                                                            </asp:HyperLink>
                                                        </td>
                                                    </tr>
                                                </table>
                                ...
                                <td width="125%" align="left" valign="top" class="style2">
                                    <span class="style4">
                                        <asp:HyperLink CssClass="link-non-orange" ID="lnkTenAnh" runat="server"></asp:HyperLink></span><br />
                                </td>
                                <td align="left" valign="top">
                                    <img alt="" src="/imagesnew/blank.gif" width="8" height="90" />
                                </td>

...
{
    public partial class KQByDay : BasePage
    {
        private int width;        
        private string lang;        
        private int id;        
        ...
        protected void HienThiNoiDung(Boolean thuchien,Boolean isLog)
        {
            ...
            string chitietGiaodich = "KQXS: " + ds.Tables[0].Rows[0]["company_name"].ToString() + " ngày " + ConvertUtility.ToDateTime(ds.Tables[0].Rows[0]["lot_time"]).ToString("dd/MM/yyyy");

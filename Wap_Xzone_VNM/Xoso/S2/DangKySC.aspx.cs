...
{
    public partial class DangKySC : BasePage
    {
        private int width;
        private string lang;
        private int id;
        ...
        protected void btnCo_Click(object sender, EventArgs e)
        {
            ...
            {
                Session["S2_Sc_Result"] = "1";
                Response.Redirect(UrlProcess.GetS2RegisterResultSoiCauUrl(lang, width.ToString(), id.ToString()));
            }
            else
            {

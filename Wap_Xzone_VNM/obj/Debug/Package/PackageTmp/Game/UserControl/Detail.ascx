<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Detail.ascx.cs" Inherits="WapXzone_VNM.Game.UserControl.Detail" %>
...
<div class="send">
    ...
    <asp:ImageButton ID="btnTang" runat="server" EnableViewState="False" 

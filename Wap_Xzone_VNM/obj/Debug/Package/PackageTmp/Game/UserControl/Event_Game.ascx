<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Event_Game.ascx.cs" Inherits="WapXzone_VNM.Game.UserControl.Event_Game" %>
...
<div class="rbroundbox">
	<div class="rbtop"><div><asp:Literal ID="ltrTieude" runat="server" EnableViewState="False">Vui cùng Noel</asp:Literal></div></div>
</div>

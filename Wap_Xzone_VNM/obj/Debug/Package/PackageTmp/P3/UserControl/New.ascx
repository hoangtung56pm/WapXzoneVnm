<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="New.ascx.cs" Inherits="WapXzone_VNM.P3.UserControl.New" %>
<div id="pnVideoList">
    <div class="headline">
    ...
    <div style="height: 27px; position: relative; text-align: center;" class="bar1 row_last group_btn"
        id="pn_more">
        <a href="javascript:loadmore('btnxemthem','pnVideoList','/P3/morePlaylist.aspx?type=new&amp;start=',5)"

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Regis.aspx.cs" Inherits="WapXzone_VNM.Sub.Regis" %>
...
<asp:Panel ID ="pnlConfirm" runat ="server" Visible =" false">
    <div class="rbroundbox">
            <div class="rbtop">
                <div>
                    <asp:Literal ID="Literal1" runat="server">Đăng ký Dịch Vụ</asp:Literal></div>
            </div>
        </div>

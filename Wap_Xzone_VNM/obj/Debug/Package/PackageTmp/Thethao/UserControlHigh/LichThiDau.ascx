<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LichThiDau.ascx.cs" Inherits="WapXzone_VNM.Thethao.UserControlHigh.LichThiDau" %>
                        ...
                        <asp:Repeater ID="rptLichThiDau" runat="server" EnableViewState="false">
                            <ItemTemplate>
                                <li>
                                    ...
                                    <span class="date-time" style="display:none;">

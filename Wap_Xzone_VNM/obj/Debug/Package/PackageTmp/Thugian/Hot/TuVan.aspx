<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TuVan.aspx.cs" Inherits="WapXzone_VNM.Thugian.Hot.TuVan" %>
...
<head>
    <title>.: Vietnamobile - Tu Van :.</title>
...
<body>
    ...
    <asp:Panel ID="pnlThongBao" Visible="false" runat="server" EnableViewState="false">
     ...
     <div class="boxcontent">
        <p>
            <b>
                 Quý khách sẽ được xem miễn phí những thông tin tư vấn dưới đây và được chọn ngẫu nhiên để trúng thưởng Samsung Galaxy S4 hàng tháng. 
            </b>
        </p>
    </div>
    ...
    <div class="rbroundbox">
	    <div class="rbtop"><div><span>Chào mừng bạn đến với dịch vụ Tư vấn (Miễn Phí) của Vietnamobile</span></div></div>
    </div>

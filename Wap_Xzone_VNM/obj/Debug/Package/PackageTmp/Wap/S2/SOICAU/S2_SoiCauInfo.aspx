<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="S2_SoiCauInfo.aspx.cs" Inherits="WapXzone_VNM.Wap.S2.SOICAU.S2_SoiCauInfo" %>
...
<head>
    <title>.: Vietnamobile - Soi Cầu :.</title>
...
<body>
    ...
    <div class="div1">
    <div>
        <p class="link-non-black"><%= AppEnv.CheckLang("Soi Cầu") %></p>
     </div>
</div>
...
<br />Cung cấp dự đoán thống kê cặp số các tỉnh nhanh chóng, chính xác, thuận tiện. Tư vấn và nhận định cặp số sẽ về trong ngày hiện tại
...
<br />Chọn đăng ký hoặc soạn tin: DK SC &lt;Mã Tỉnh&gt; gửi <%= AppEnv.GetSetting("S2ShortCode")%> (miến phí đăng ký)
<br />Hủy đăng ký soạn tin: HUY SC &lt;Mã Tỉnh&gt; gửi <%= AppEnv.GetSetting("S2ShortCode")%>

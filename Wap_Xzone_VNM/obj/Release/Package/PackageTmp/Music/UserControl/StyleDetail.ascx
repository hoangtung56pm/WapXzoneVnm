<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StyleDetail.ascx.cs" Inherits="WapXzone_VNM.Music.UserControl.StyleDetail" %>
...
<div class="boxcontent">
    <div class="hotnews" style="border-bottom:#b200b2 1px solid;"> 
  		<asp:Literal ID="ltrStyleName" runat="server" EnableViewState="False"></asp:Literal><br>    	

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnChoi.aspx.cs" Inherits="WapXzone_VNM.Thugian.Hot.AnChoi" %>
...
<head>
    <title>.: Vietnamobile - Dia Diem An Choi :.</title>
...
<body>
    ...
    <asp:Panel ID="pnlThongBao" Visible="false" runat="server" EnableViewState="false">
     ...
     <div class="boxcontent">
        <p>
            <b>
                 Quý khách sẽ được cung cấp miễn phí thông tin địa điểm ăn chơi dưới đây và được chọn ngẫu nhiên để trúng thưởng Samsung Galaxy S4 hàng tháng. 
            </b>
        </p>
    </div>
    ...
    <div class="rbroundbox">
	    <div class="rbtop"><div><span>Chào mừng bạn đến với dịch vụ Địa điểm Ăn và Chơi (Miễn Phí) của Vietnamobile</span></div></div>
    </div>

    <div class="boxcontent">
        

        <asp:Repeater ID="rptTopAnChoi" runat="server" EnableViewState="false">
            <ItemTemplate>
                <div class="item">

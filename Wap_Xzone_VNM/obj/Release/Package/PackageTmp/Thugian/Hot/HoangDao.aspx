<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HoangDao.aspx.cs" Inherits="WapXzone_VNM.Thugian.Hot.HoangDao" %>
...
<body>
    ...
    <asp:Panel ID="pnlThongBao" Visible="false" runat="server" EnableViewState="false">
     ...
     <div class="boxcontent">
        <p>
            <b>
                 Quý khách sẽ được xem miễn phí những tư vấn Cung Hoàng Đạo hay dưới đây và được chọn ngẫu nhiên để trúng thưởng Samsung Galaxy S4 hàng tháng. 
            </b>
        </p>
    </div>
    ...
    <div class="rbroundbox">
	    <div class="rbtop"><div><span>Chào mừng bạn đến với dịch vụ Cung Hoàng Đạo (Miễn Phí) của Vietnamobile</span></div></div>
    </div>

    <div class="boxcontent">
        

        <asp:Repeater ID="rptHoangDao" runat="server" EnableViewState="false">
            <ItemTemplate>
                <div class="item">

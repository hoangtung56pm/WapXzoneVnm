...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Detail.ascx.cs" Inherits="WapXzone_VNM.Video.UserControl.Detail" %>
...
<div class="boxcontent">
    <div class="item">
        ...
        <%--<asp:HyperLink ID="lnkXem" runat="server" EnableViewState="False">--%>
        <p>
            <img style="padding-left:3px;" src="../img/icontv.png">
            <asp:HyperLink ID="lnkXem" runat="server" EnableViewState="False"><span class="bold">Xem trực tuyến</span></asp:HyperLink>
        </p>
        <%--</asp:HyperLink>--%>

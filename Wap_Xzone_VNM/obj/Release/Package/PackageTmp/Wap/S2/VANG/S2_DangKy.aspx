<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="S2_DangKy.aspx.cs" Inherits="WapXzone_VNM.Wap.S2.VANG.S2_DangKy" %>
...
<head>
    <title>.: Wap Vietnamobile - VANG :.</title>
...
<body>
    ...
    <asp:Panel ID="pnlThongBao" runat="server" Visible="false">
        <div class="rbroundbox">
            <div class="rbtop">
                <div>
                    <asp:Literal ID="ltrTitle" runat="server">Giá vàng</asp:Literal></div>
            </div>
        </div>
        <div style="text-align: center;" class="boxcontent">
            <p style="text-align: left;">
    ...
    <asp:Panel ID="pnlNoiDung" runat="server" Visible="false">
        <div class="rbroundbox">
            <div class="rbtop">
                <div>
                    <asp:Literal ID="ltrTieuDe" runat="server">Gia Vang</asp:Literal></div>
            </div>
        </div>

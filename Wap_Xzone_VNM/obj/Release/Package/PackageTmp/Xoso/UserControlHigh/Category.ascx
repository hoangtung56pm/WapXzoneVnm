<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Category.ascx.cs" Inherits="WapXzone_VNM.Xoso.UserControlHigh.Category" %>


<div class="rbroundbox">
    <div class="rbtop"><div class="download-style"><asp:Label ID="lblOthersService" runat="server" EnableViewState="False">CAC DICH VU</asp:Label></div></div>
</div>
